/* src/config/giracoin-config.h.  Generated from giracoin-config.h.in by configure.  */
/* src/config/giracoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GIRACOIN_CONFIG_H

#define GIRACOIN_CONFIG_H
...
#define COPYRIGHT_HOLDERS "The %s Developers - Gira Financial Group AG (http://www.gira-financial.com)"

/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Giracoin Core Developers - Gira Financial Group AG (http://www.gira-financial.com)"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Giracoin Core"
...
/* Define to 1 to enable staking functions */
#define ENABLE_STAKING 1
...
#define PACKAGE_BUGREPORT "https://giracoin.com/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Giracoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Giracoin Core 0.13.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "giracoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://giracoin.com/"
